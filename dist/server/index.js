...
function () {
  function Server() {
    ...
    }) : null; // Only serverRuntimeConfig needs the default
  ...
  (0, _createClass2.default)(Server, [{
    ...
    key: "mountRoutes",
    value: function mountRoutes(routes) {
      var _arr = ['GET', 'HEAD'];

      for (var _i = 0; _i < _arr.length; _i++) {
        var method = _arr[_i];

        var _arr2 = (0, _keys.default)(routes);
    ...
    key: "hookEssentialRoutes",
    value: function hookEssentialRoutes() {
      var _this2 = this;
      ...
      var routes = {
        '/_next-prefetcher.js': function () {
          ...
          /*#__PURE__*/
          _regenerator.default.mark(function _callee(req, res, params) {
            var p;
        ...
        '/_next/webpack/chunks/:name': function () {
          ...
          /*#__PURE__*/
          _regenerator.default.mark(function _callee2(req, res, params) {
            var p;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    p = (0, _path.join)(_this2.dir, _this2.dist, 'chunks', params.name);
                    _context2.next = 4;
                    return _this2.serveStatic(req, res, p);
            ...
            return _regenerator.default.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    p = (0, _path.join)(_this2.dir, _this2.dist, 'chunks', params.id);
                    _context3.next = 3;
                    return _this2.serveStatic(req, res, p);
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    _context4.prev = 3;
                    _context4.next = 6;
                    return _this2.hotReloader.ensurePage(page);
                  ...
                  case 8:
                    ...
                    _context4.next = 12;
                    return _this2.render404(req, res);

                  case 12:
                    path = (0, _path.join)(_this2.dir, _this2.dist, 'bundles', 'pages', "".concat(page, ".js.map"));
                    _context4.next = 15;
              ...
              while (1) {
                switch (_context5.prev = _context5.next) {
                  case 0:
                    ...
                    if (_this2.handleBuildId(params.buildId, res)) {
                      _context5.next = 7;
                      break;
                    }
                  ...
                  case 7:
                    if (!(_this2.dev && page !== '/_error' && page !== '/_app')) {
                      _context5.next = 25;
                      break;
                    }
                  ...
                  case 13:
                    ...
                    _context5.next = 17;
                    return (0, _render3.renderScriptError)(req, res, page, _context5.t0);
                  ...
                  case 18:
                    _context5.next = 20;
                    return _this2.getCompilationError();

                  case 20:
                    compilationErr = _context5.sent;
                  ...
                  case 25:
                    p = (0, _path.join)(_this2.dir, _this2.dist, 'bundles', 'pages', "".concat(page, ".js")); // [production] If the page is not exists, we need to send a proper Next.js style 404
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    if (_this2.dev && params.path[0] === 'commons') {
                      res.setHeader('Cache-Control', 'no-store, must-revalidate');
                    }

                    p = _path.join.apply(void 0, [_this2.dir, _this2.dist, 'static'].concat((0, _toConsumableArray2.default)(params.path || [])));
                    _context6.next = 4;
                    return _this2.serveStatic(req, res, p);
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 9:
                ...
                console.error('Error checking updates', _context9.t0);
            ...
            switch (_context10.prev = _context10.next) {
              ...
              case 3:
                ...
                return new _promise.default(function (resolve, reject) {
                  _this3.http.close(function (err) {
                      ...
                      return _regenerator.default.wrap(function _callee11$(_context11) {
                        while (1) {
                          switch (_context11.prev = _context11.next) {
                            case 0:
                              _context11.next = 2;
                              return _this4.render(req, res, options.page, options.query, parsedUrl);
                      ...
                      while (1) {
                        switch (_context12.prev = _context12.next) {
                          case 0:
                            ...
                            _context12.next = 3;
                            return _this4.render(req, res, pathname, query, parsedUrl);
            ...
            switch (_context14.prev = _context14.next) {
              ...
              case 2:
                ...
                return new _promise.default(function (resolve, reject) {
                  ...
                  _this5.http.on('error', reject);

                  _this5.http.on('listening', function () {
                    return resolve();
                  });

                  _this5.http.listen(port, hostname);
                });
