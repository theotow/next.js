...
function () {
  ...
  (0, _createClass2.default)(Server, [{
    ...
    key: "generateRoutesSync",
    value: function generateRoutesSync() {
      var _this2 = this;
        ...
        return _regenerator.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                return _context7.abrupt("return", this.generateRoutesSync());
    ...
    key: "defineRoutesSync",
    value: function defineRoutesSync() {
      var routes = this.generateRoutesSync();
      var _arr = ['GET', 'HEAD'];
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee8() {
        var routes, _arr2, _i2, method, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, route;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 5:
                ...
                for (_iterator2 = (0, _getIterator2.default)(routes); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                  route = _step2.value;
                  this.router.add(method, route.path, route.fn);
                }
            ...
            switch (_context10.prev = _context10.next) {
              ...
              case 11:
                if (this.nextConfig.poweredByHeader) {
                  res.setHeader('X-Powered-By', "Next.js 7.0.1");
                }
